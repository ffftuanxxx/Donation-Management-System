...
<body>
  ...
  <section id="hero" class="d-flex justify-content-center align-items-center">
    <div class="container position-relative" data-aos="zoom-in" data-aos-delay="100">
      <h1>Donating Today,<br>happy Tomorrow</h1>
      <h2>We are a donating website for poverty-stricken and disaster religion</h2>
      <?php if(isset($_SESSION["username"]) && isset($_SESSION["password"]) && $_SESSION["username"] && $_SESSION["password"]){ ?>
      <?php }else{ ?>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          ...
          <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 content">
            <h3>
              a online and resources-integrated donation channels</h3>
            <p class="fst-italic">
              The world in different places have been suffered from poverty and disaster for many years because it seldom
              has approaches for the donation of those places.
            </p>
            <ul>
              <li><i class="bi bi-check-circle"></i> people can browse the donated area information around all of the world
              </li>
              <li><i class="bi bi-check-circle"></i> people can contribute all the poverty-stricken and disaster religion
                they want</li>
              <li><i class="bi bi-check-circle"></i> The purpose of our project is build up a dynamic website for a
                real-world application, which is a donation
                website for poverty-stricken and disaster religion.</li>
            </ul>
            <p>
              we are intended to build a website to gain fund from difference places of the world, and deliver warm hearted
              words to those needed places and people.
            </p>
