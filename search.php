...
$sqlse="SELECT * from individual where title like '%$keywords%' or information like '%$keywords%' or total_money like '%$keywords%' or type like '%$keywords%' UNION SELECT * from animal where title like '%$keywords%' or information like '%$keywords%' or total_money like '%$keywords%' or type like '%$keywords%' UNION SELECT * from area where title like '%$keywords%' or information like '%$keywords%' or total_money like '%$keywords%' or type like '%$keywords%' UNION SELECT * from plant where title like '%$keywords%' or information like '%$keywords%' or total_money like '%$keywords%' or type like '%$keywords%' UNION SELECT * from relic where title like '%$keywords%' or information like '%$keywords%' or total_money like '%$keywords%' or type like '%$keywords%';";
